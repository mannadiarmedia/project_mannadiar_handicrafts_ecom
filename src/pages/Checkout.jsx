...
export default function Checkout({ cart, setCart, cartTotal }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Inter', backgroundColor: '#fff', flexDirection: 'row' }} className="checkout-container">
      
      {/* LEFT COLUMN - FORM */}
      <div style={{ flex: 1, padding: '40px 10%', borderRight: '1px solid #e0e0e0' }}>
        <div style={{ marginBottom: '32px' }}>
          <Link to="/shop" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: '#666', fontSize: '0.9rem' }}>
            <ChevronLeft size={16} /> Back to Shop
          </Link>
          <h1 style={{ fontSize: '2rem', fontFamily: 'Playfair Display', marginTop: '24px' }}>Mannadiar Handicrafts</h1>
        </div>
      ...
      <div style={{ flex: '0 0 45%', padding: '40px 5%', backgroundColor: '#fafafa' }}>
