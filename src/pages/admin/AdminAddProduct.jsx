...
export default function AdminAddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      delete productToInsert.dimensions; // Ensure old field isn't sent
  ...
  return (
    <div style={{ maxWidth: '800px' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 300, fontFamily: 'Playfair Display' }}>Add New Product</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ backgroundColor: '#fff', padding: '32px', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          <div>
            ...
            <input name="title" value={formData.title} onChange={handleChange} required type="text" placeholder="e.g. Bronze Nataraja" style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontFamily: 'Inter' }} />
          </div>
          <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '24px' }}>
          <div>
            ...
            <input name="price" value={formData.price} onChange={handleChange} required type="number" placeholder="50000" style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontFamily: 'Inter' }} />
          </div>
          <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px' }}>
          <div>
            ...
            <input name="material" value={formData.material} onChange={handleChange} required type="text" placeholder="e.g. Panchaloha" style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontFamily: 'Inter' }} />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea name="description" value={formData.description} onChange={handleChange} rows="3" placeholder="General description..." style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontFamily: 'Inter', resize: 'vertical' }}></textarea>
        </div>

        <div>
          <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500, color: '#444' }}>The Story Behind the Art</label>
          <textarea name="story" value={formData.story} onChange={handleChange} rows="3" placeholder="Enter the rich history and Vedic significance here..." style={{ width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '4px', fontFamily: 'Inter', resize: 'vertical' }}></textarea>
        </div>
            ...
            <div style={{ position: 'relative', border: '2px dashed #ccc', borderRadius: '8px', padding: '40px', textAlign: 'center', backgroundColor: '#fafafa', cursor: 'pointer' }}>
              ...
              {uploading ? (
                ...
                <>
                  ...
                  <p style={{ color: '#666', margin: 0 }}>Click or drag a product photo here</p>
